                ...
                <div className="flex h-[80vh] items-center justify-center">
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <p className="text-sm font-medium text-muted-foreground">Mapeando toda a operação da Newflexo no banco de dados.</p>
                        </div>
                    </div>
                </div>
            </AppShell>
                                                    ...
                                                    <div className="flex items-center justify-end gap-2">
                                                        <Button 
                                                            ...
                                                            onClick={() => {
                                                                ...
                                                                window.open(`https://api.whatsapp.com/send?phone=55${tel}&text=Olá ${c.razaoSocial}, tudo bem? Sou da Newflexo e vi que faz um tempo que não conversamos sobre novos orçamentos...`, '_blank')
                                                            }}
                                                        >
